...
// 
//  SuperTux
//  Copyright (C) 2004 Super Turr Development Team, see AUTHORS for details
//
...
#ifndef SUPERTURR_LEVEL_H
#define SUPERTURR_LEVEL_H
...
class Level 
{
 public:
  ...
  /** A collection of points to which Turri can be reset after a lost live */
...
//extern Level new_lev;
// extern std::string song_title;
// extern MusicRef get_level_music();

#endif /*SUPERTURR_LEVEL_H*/
