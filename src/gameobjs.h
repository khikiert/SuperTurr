...
#ifndef SUPERTURR_GAMEOBJS_H
#define SUPERTURR_GAMEOBJS_H
...
/* Bounciness of diamonds: */
#define NO_BOUNCE 0
#define BOUNCE 1

class BouncyDiamond : public GameObject
{
 public:
  ...
  void draw(); 
  std::string type() { return "BouncyDiamond"; };
};

extern Surface* img_diamond[10];
