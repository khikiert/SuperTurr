...
#ifndef SUPERTURR_WORLDMAP_H
#define SUPERTURR_WORLDMAP_H
...
public:
  ...
  // Directions in which Turri is allowed to walk from this tile
  bool north;
  bool east;
  bool south;
  bool west;
...
private:
  WorldMap* worldmap;
  Surface* turrican_sprite;
  Surface* turricanUpgrade_sprite;
  Surface* turriball_sprite;

  Direction input_direction;
  Direction direction;
  Point tile_pos;
  /** Length by which Turri is away from its current tile, length is in
