...
int le_menu_check;
int le_level_loaded = 0;
int quit_level_editor = 0;
...
int leveleditor(char* filename)
{
  ...
  if(filename != NULL) {
fprintf(stdout, "LEDITOR filename != null...\n");
    if(le_load_level_subset(filename)) {
fprintf(stdout, "LEDITOR loadlevelsubset!!!!!\n");
le_level_loaded = 1;
      return 1;
  ...
  fprintf(stdout, "petlahujowa \n");
    ...
    if(menu)
    {
fprintf(stdout, "jestesmy w jebanym menu\n");
      menu->draw();
      menu->action();

      if(menu == leveleditor_menu)
      {
fprintf(stdout, "a teraz w jebanym menu LE\n");
le_menu_check = leveleditor_menu->check();
		...
		fprintf(stdout, "QUIT ma byc wlasnie tu\n");
          done = 1;

		}
          break;
          default: {
          fprintf(stdout, "jeb sie! %i\n", leveleditor_menu->check());
  //        le_quit();
//          return 0;
          }
          break;
      ...
      {
fprintf(stdout, "a teraz w kutasowym menu settings\n");
      ...
      {
fprintf(stdout, "a teraz w hujowym menu tilegroup\n");
        int it = -1;
      ...
      {
fprintf(stdout, "a teraz w menu skurwysynow objects\n");
        int it = -1;
      ...
      {
fprintf(stdout, "a teraz w pierdolonym load menu\n");
      ...
      {
fprintf(stdout, "a teraz w pojebanym new menu\n");
      ...
      {
fprintf(stdout, "a teraz w subset settings i SPIERDALAJ\n");
...
void le_drawlevel()
{
  ...
  for (y = 0; y < 15; ++y)
    for (x = 0; x < 20; ++x)
    {
      ...
      Tile::draw(32*x - fmod(pos_x, 32), y * 32, le_world->get_level()->bg_tiles[y][x + (int)(pos_x / 32)],a);
      ...
      Tile::draw(32*x - fmod(pos_x, 32), y * 32, le_world->get_level()->ia_tiles[y][x + (int)(pos_x / 32)],a);
      ...
      Tile::draw(32*x - fmod(pos_x, 32), y * 32, le_world->get_level()->fg_tiles[y][x + (int)(pos_x / 32)],a);
  ...
  turricanUpgrade.walk_right->draw( 100 - pos_x, 240);
}
...
fprintf(stdout, "SKURWYSYN %i\n", event.type);
  ...
  fprintf(stdout, "HUJ:::: wyjscie z edytora\n");
            	done = 1;
  fprintf(stdout, "HUJ2:::: wyjscie z edytora\n");
	            done = 1;
  fprintf(stdout, "HUJ3:::: wyjscie z edytora\n");
    	        le_quit();
  fprintf(stdout, "HUJ4:::: wyjscie z edytora\n");
//    	    	return;
    	    }
            else {
...
void le_showhelp()
{
  ...
  char *text[] = {
                   ...
                   " - SuperTurr level editor tutorial - ",
                   "",
                   ...
                   "Turri in the gameplay, but lie in",
  ...
  char *text2[] = {
                    ...
                    "which actually effect Turri in the",
                    "game.",
                    "",
