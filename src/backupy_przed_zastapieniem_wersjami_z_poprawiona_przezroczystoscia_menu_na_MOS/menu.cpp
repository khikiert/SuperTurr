...
fprintf(stdout, "Title image, Menu::logo_timer.get_left() = \n");
  if (menu) 
    if (menu == game_menu) {
    	menu->effect.start(500);
    	fprintf(stdout, "menu opt. 1\n");
    }
    else if (menu == worldmap_menu) {
    	menu->effect.start(500);
    	fprintf(stdout, "menu opt. 2\n");
    }
	else if (title_animation) {
//		while(title_animation) { }
		fprintf(stdout, "menu opt. 3\n");
		title_animation = 0;
		fprintf(stdout, "wyzerowalem title_animation i uruchamiam jebany efekt.\n");
		menu->effect.start(500);
	}
    else if (current_ != main_menu) {
    	menu->effect.start(750);
    	fprintf(stdout, "menu opt. 4\n");
    }
//    else if (menu == main_menu) {
//    	menu->effect.start(500);
//    	fprintf(stdout, "menu opt. 5\n");
//    }
//    else if (current_ != main_menu) {
//    	menu->effect.start(750);
//    	fprintf(stdout, "menu opt. 6\n");
//    }

//    if (logo_timer.get_left() < 0) menu->effect.start(5000);
