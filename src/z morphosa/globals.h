...
#ifndef SUPERTURR_GLOBALS_H
#define SUPERTURR_GLOBALS_H
...
// extern Text* turri_text1;
extern Text* lives_text;
...
/* Super Turr directory ($HOME/.superturr) and save directory($HOME/.superturr/save) */
extern char* st_dir;
