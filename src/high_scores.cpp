...
void load_hs(void)
{
  ...
  if (strcmp(lisp_symbol(lisp_car(root_obj)), "superturr-highscore") == 0)
    {
  ...
  if(fwriteable(filename.c_str()))
    {
      ...
      /* Write header: */
      fprintf(fi,";Super Turr HighScores\n");
      fprintf(fi,"(superturr-highscore\n");
...
/*
  ...
  if (fi != NULL)
    {
      fprintf(fi, "# Super Turr highscore file\n\n");
