...
{
  std::string filename = datadir + "/images/tilesets/superturr.stgt";
          ...
          if (strcmp(lisp_symbol(lisp_car(element)), "tile") == 0)
            {
              ...
              reader.read_bool("diamond",    &tile->diamond);
              reader.read_bool("turriwater",     &tile->turriwater);
