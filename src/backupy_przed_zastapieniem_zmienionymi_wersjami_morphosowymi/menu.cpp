...
Menu::set_current(Menu* menu)
{
  ...
  if (menu)
    if (menu == game_menu) menu->effect.start(500);
    else if (menu == worldmap_menu) menu->effect.start(500);
    else if (logo_timer.get_left() < 0) menu->effect.start(500);
    else if (current_ != main_menu) menu->effect.start(750);
